...
public class FuerEsp {
    ...
    public FuerEsp() {
        ...
        recursos.add(e3);
        recursos.add(f3);
        Mision m1 = new Mision(LocalDate.now(), "Madrid", "alpha", 3);
        misiones.put("1", m1);
        MisionCombate m2= new MisionCombate(LocalDate.now(), "Venecia", "Ganma", 0, 2);
        misiones.put("2", m2);
    }
    ...
    public void resultadoMision(){
        ...
        switch (exito){
            case 1:misionExito(tempResul,exp);
            
                break;
            case 2:misionFracaso(tempResul, exp);
